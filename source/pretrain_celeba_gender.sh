...
ndis=2543      # total number of discriminators
...
for i in $(seq 0 $njobs); do
  ...
  vals=$(seq $start $end)
  python pretrain_celeba_gender.py -data 'celeba_gender' -ids $vals --pretrain -gen 'ResNet' -name 'ResNet_default' -noise 0. -piters 12000 -ndis $ndis -bs 32
done